    ...
    <div class="row">
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/index.php/raffles">
        ...
        <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
            <div class="col-12 col-md-15 mb-4 mb-lg-0 col-lg-50">
                <h1 class="h2">Crear una Rifa</h1>
                <br>
                <form action="/index.php/raffles" method="post">
                    <div class="form-group">
                        <label for="title">Título</label>
                        <input type="text" name="title" class="form-control" id="title" aria-describedby="" required>
                    </div>
                    <div class="form-group">
                        <label for="firstTicket">Primer ticket</label>
                        <input type="number" name="firstTicket" id="firstTicket" class="form-control"
                            aria-describedby="" required>
                    </div>
                    <div class="form-group">
                        <label for="lastTicket">Último ticket</label>
                        <input type="number" name="lastTicket" id="lastTicket" class="form-control" aria-describedby=""
                            required>
                    </div>
                    <div class="form-group">
